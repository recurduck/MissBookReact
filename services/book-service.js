...
function updateBook(bookId, newPrice) {
    ...
    book.listPrice.amount = newPrice;
    _saveBooksToStorage();
}
...
function _createBook(title, price) {
    ...
    return {
      ...
      title: title,
      subtitle: makeLorem(9),
      authors: ["Anna Walstead"],
      categories: ["Computers", "Hack"],
      description: "interdum inceptos mauris habitant primis neque tempus lacus morbi auctor cras consectetur euismod vehicula neque netus enim vivamus augue molestie imperdiet tincidunt aliquam",
      listPrice: { amount: price, currencyCode: "USD", isOnSale: false },
      pageCount: utilService.getRandomIntInclusive(80, 970),
      language: "en",
      description: utilService.makeLorem(),
      publishedDate: utilService.getRandomIntInclusive(1919, 2020),
